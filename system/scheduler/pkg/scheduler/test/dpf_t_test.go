...
func TestBudgetReleaseConservation(t *testing.T) {
	option := scheduler.DefaultTSchemeOption()
	option.DefaultReleasingPeriod = 1000
	option.DefaultReleasingDuration = 10000
	...
	block = getDataBlock(block.Name)
	printJson(t, block)
}

func TestDpfT(t *testing.T) {
	option := scheduler.DefaultTSchemeOption()
	option.DefaultReleasingPeriod = 5000
	option.DefaultReleasingDuration = 15000
	startScheduler(option)
