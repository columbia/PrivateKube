...
config = {
    'workload_test.enabled': True,  # if enabled, generate workload from trace file.
    ...
    'resource_master.block.is_static': True,  # whether new blocks are generated dynamically
    'resource_master.block.init_amount': 3,  # initial amount of data blocks before the simulation starts
    ...
    'resource_master.dp_policy': DpPolicyType.DP_POLICY_FCFS,  # the policy name of scheduler
...
def test_fcsf():
    simulate(config, Top)
# should grant task 0 1 3 reject task 2
